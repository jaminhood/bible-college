...
export default function Home ()
{
  ...
  useEffect(() => { (user.role !== undefined) ? (user.role === `student`) ? navigate(`/exam-list`) : navigate(`/admin/dashboard`) : false })
            ...
            <Row>
              ...
              <Col md={6}>
                <FormGroup className='p-2'>
                  <label htmlFor="name" className='mb-3'>Please Enter Your Full Name:</label>
                  <input type="text" className="form-control" id="name" placeholder='John Doe' value={name} onInput={e => setName(e.target.value)} autoComplete='off' />
                </FormGroup>
                <FormGroup className='p-2'>
                  <label htmlFor="name" className='mb-3'>Please Enter Your Matric Number:</label>
                  <input type="text" className="form-control" id="name" placeholder='123456' value={matricNumber} onInput={e => setMatricNumber(e.target.value)} autoComplete='off' />
                </FormGroup>
                <FormGroup className='p-2'>
                  <motion.button whileTap={{ scale: 1.1 }} className="btn btn-success btn-lg w-100" onClick={handleStart} disabled={!canSend}>
                    List Exams
